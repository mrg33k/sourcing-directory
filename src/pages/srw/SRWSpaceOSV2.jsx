...
const FEATURES = [
  { name: 'Companies', desc: "Arizona's space companies — from primes to early-stage startups — in one searchable directory.", to: '/os' },
  { name: 'Jobs',      desc: 'Open roles across the state aerospace sector, posted by the companies hiring.',                    to: '/os/jobs' },
  { name: 'Events',    desc: 'Conferences, roundtables, and convenings keeping the ecosystem connected.',                       to: '/os/events' },
  { name: 'Resources', desc: 'Grants, reports, and tools for builders navigating the space economy.',                            to: '/os/reports' },
];
      ...
      >
        <div className="srw-pg-hero-inner">
          ...
          <div className="srw-pg-cta-row">
            <Link to="/os" className="srw-pg-cta solid">Enter the directory →</Link>

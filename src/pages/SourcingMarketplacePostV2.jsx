    ...
    return (
      <div data-srw="v2" style={{ minHeight: '100dvh', background: BG, color: TEXT, fontFamily: FONT }}>
        ...
        <div style={{ textAlign: 'center', padding: '80px 24px' }}>
          ...
          <Link to="/spaceos/marketplace" style={{
    ...
    <div data-srw="v2" style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <Link to="/spaceos/marketplace" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, marginTop: 16, fontSize: 13, color: MUTED, textDecoration: 'none', fontFamily: FONT }}>

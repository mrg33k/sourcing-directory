...
export default function PendingContentSection({ pendingContent, pendingContentCompanyMap, handleArticleAction, V }) {
  return (
    <AdminSection title={`Pending Content (${pendingContent.length})`} V={V}>
      {pendingContent.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {pendingContent.map(article => {
            const company = pendingContentCompanyMap[article.id];

  ...
  return (
    <div className="srsv2-shell" data-tenant="space-rising-v2">
      ...
      <div className="srsv2-topbar">
        <Link to="/os" className="srsv2-wordmark">SPACE RISING</Link>
        <div className="srsv2-progress"></div>
        <Link to="/os" className="srsv2-close" aria-label="Close">
          ...
          {status === 'paid' && (
            <>
              ...
              <div className="srsv2-cta-row">
                <Link to={company?.slug ? `/os/${company.slug}` : '/os'} className="srsv2-cta srsv2-cta-solid">
                  Go to your profile
                </Link>
                <Link to="/os" className="srsv2-cta srsv2-cta-line">
          ...
          {status === 'timeout' && (
            <>
              ...
              <div className="srsv2-cta-row">
                ...
                <Link to="/os" className="srsv2-cta srsv2-cta-line">Browse the directory</Link>
              </div>
            </>
          )}

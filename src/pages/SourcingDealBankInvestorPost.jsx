...
// Route: /os/deal-bank/list-your-firm.
    ...
    return (
      <div data-tenant={TENANT_SLUG_V2} style={{ minHeight: '100dvh', background: 'var(--bg)', color: TEXT, fontFamily: FONT, ...PAGE_VARS }}>
        <div style={{ textAlign: 'center', padding: '96px 24px' }}>
          ...
          <Link to="/os/deal-bank" style={{ background: AMBER, color: '#0B0B0D', textDecoration: 'none', borderRadius: 6, padding: '12px 28px', fontWeight: 700, fontSize: 14 }}>
            Back to Deal Bank
          </Link>
        </div>
      </div>
      ...
      <div className="browse-hero" style={{ '--page-hero-bg': "url('/v2-assets/earth.png')" }}>
        ...
        <div className="browse-hero-content" style={{ position: 'relative' }}>
          <div className="browse-hero-toprow">
            <Link to="/os/deal-bank" className="browse-back" style={{ textDecoration: 'none' }}>

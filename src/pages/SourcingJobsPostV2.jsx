      ...
      <div data-srw="v2" style={{ minHeight: '100dvh', background: BG, color: TEXT, fontFamily: FONT }}>
        ...
        <div style={{ textAlign: 'center', padding: '80px 24px' }}>
          ...
          <div style={{ fontSize: 15, color: MUTED, marginBottom: 28, lineHeight: 1.6, fontFamily: FONT }}>
            Your listing is live. Members of the Sourcing Directory directory can now find it.
          </div>
          <Link to="/os/jobs" style={{
    ...
    <div data-srw="v2" style={{ minHeight: '100dvh', background: BG, color: TEXT, fontFamily: FONT }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <Link to="/os/jobs" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, marginTop: 16, fontSize: 13, color: MUTED, textDecoration: 'none', fontFamily: FONT }}>

  ...
  return (
    <div style={{ minHeight: '100dvh', background: 'var(--bg)', color: 'var(--tx)' }}>
      ...
      <div className="browse-hero" style={{ minHeight: 200 }}>
        <div className="browse-hero-bg" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800&q=80')" }} />
        ...
        <div className="browse-hero-content">
          ...
          <div className="browse-title">Job Board</div>
          <div className="browse-sub">Open positions at Arizona's top companies</div>
        </div>
      </div>
      ...
      <div style={{ padding: '0 24px 80px', maxWidth: 860, margin: '0 auto' }}>
        <div className="sec-hdr" style={{ padding: '12px 0' }}>
          ...
          <Link to={`${tenantSlug ? `/${tenantSlug}` : '/'}/jobs/post`} style={{ textDecoration: 'none', color: 'var(--cyan)', fontSize: 12, fontWeight: 600 }}>+ Post a Job</Link>
        </div>

        {/* Filters row -- kept but simplified */}

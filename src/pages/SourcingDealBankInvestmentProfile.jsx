...
// Route: /os/deal-bank/investments/:slug.
    ...
    return (
      ...
      >
        <div style={{ textAlign: 'center' }}>
          ...
          <Link
            to="/os/deal-bank?tab=investments"
      ...
      <div className="browse-hero" style={{ '--page-hero-bg': "url('/v2-assets/earth.png')" }}>
        ...
        <div className="browse-hero-content" style={{ position: 'relative' }}>
          <div className="browse-hero-toprow">
            <Link to="/os/deal-bank?tab=investments" className="browse-back" style={{ textDecoration: 'none' }}>
